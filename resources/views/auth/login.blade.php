...
<head>
    ...
    <style>
        :root {
            --dark-mood-color: #fff;
            --light-mood-color: #272727;
            --dark-main-color: #885DDD;
            --light-main-color: #A986ED;
            --light-text-color: #432482;
        }
        ...
        *::before {
        ...
        button {
            ...
            color: var(--dark-mood-color);
            font-size: 17px;
            padding: 13px 30px;
            letter-spacing: 1px;
            cursor: pointer;
            box-shadow: 1px 2px 5px #8a8a8a94;
        ...
        button:hover {
            cursor: pointer;
            background-color: var(--light-mood-color);
            border-color: var(--light-mood-color);
        }
        ...
        input[type="checkbox"] {
            ...
            height: 15px;
            cursor: pointer;
            accent-color: var(--dark-main-color);
        }

        a.forget,
        input[type="checkbox"],
        label {
            color: var(--light-mood-color);
            font-size: 16px;
            cursor: pointer;
        ...
        .login {
            left: 0;
            background: var(--dark-mood-color);
        ...
        .page button {
            border-color: var(--light-mood-color);
            background: var(--light-mood-color);
            margin-top: 60px;
        }
        ...
        .front {
            background: linear-gradient(-45deg, var(--light-main-color) 0%, var(--dark-main-color) 100%) no-repeat 0 0/200%;
            z-index: 3;
        }
        ...
        .back {
            background: linear-gradient(135deg, var(--dark-main-color) 0%, var(--light-main-color) 100%) no-repeat 0 0/200%;
            z-index: 2;
        }
...
<body>
    <div id="container" class="login-signup">
        ...
        <div class="login">
            <div class="content">
                <h1 data-aos="fade-down" data-aos-delay="100">{{ __('Log In') }}</h1>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <label for="remember_me" data-aos="fade-right" data-aos-delay="400">{{ __('Remember me') }}</label>
                    ...
                    <button type="submit" data-aos="fade-up" data-aos-delay="400">{{ __('Log in') }}</button>
                </form>
            </div>
        </div>

        <!-- الصفحة الأمامية (للانتقال إلى التسجيل) -->
        <div class="page front">
            <div class="content">
                <i class="fas fa-user-plus" data-aos="fade-down" data-aos-delay="100"></i>
                <h1 data-aos="fade-down" data-aos-delay="200">{{ __('Hello, friend!') }}</h1>
                <p data-aos="fade-down" data-aos-delay="300">{{ __('Enter your personal details and start journey with us') }}</p>
                <a href="{{ route('register') }}" id="signup" data-aos="fade-up" data-aos-delay="400">
                    {{ __('Sign up') }} <i class="fa-solid fa-chevron-right"></i>
                </a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // JavaScript from the second file
